...
**注意：该插件由于发版，暂时并不完善，仍在测试阶段，如果无法运行，可以选择同类替代产品，如：[安全跳转页面重制版](https://blog.qyliu.top/posts/9efc1657/)，等测试期结束后，我将会推出兼容性良好的版本，如果感兴趣可以star以关注后续更新！**
...
- **自定义页面**：本插件自定义页面简单明了，完全可以进行自定义以达到自己的要求。
